...
Drop table if exists TPercentPopulationVaccinated
create table TPercentPopulationVaccinated (
continent nvarchar(255),
Location nvarchar(255),
Date datetime,
Population numeric,
...
Insert into TPercentPopulationVaccinated
Select continent, Location, Date, Population, new_vaccination, RollingPeopleVaccinated
from #PercentPopulationVaccinated

select *
from TPercentPopulationVaccinated
